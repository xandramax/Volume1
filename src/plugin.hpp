...
extern DelexandraVol1Settings pluginSettings;
...
struct KnobModeAction : history::ModuleAction {
	...
	KnobModeAction() {
		name = "Delexandra Algomorph knob mode";
	}
...
struct AuxInputSetAction : history::ModuleAction {
	...
	AuxInputSetAction() {
		name = "Delexandra Algomorph AUX In mode set";
	}
...
struct AuxInputSwitchAction : history::ModuleAction {
	...
	AuxInputSwitchAction() {
		name = "Delexandra Algomorph AUX In mode switch";
	}
...
struct AuxInputUnsetAction : history::ModuleAction {
	...
	AuxInputUnsetAction() {
		name = "Delexandra Algomorph AUX In mode unset";
	}
...
struct RandomizeCurrentAlgorithmAction : history::ModuleAction {
	...
	RandomizeCurrentAlgorithmAction() {
		name = "Delexandra Algomorph randomize current algorithm";
	}
...
struct RandomizeAllAlgorithmsAction : history::ModuleAction {
	...
	RandomizeAllAlgorithmsAction() {
		name = "Delexandra Algomorph randomize all algorithms";
	}
...
struct InitializeCurrentAlgorithmAction : history::ModuleAction {
	...
	InitializeCurrentAlgorithmAction() {
		name = "Delexandra Algomorph initialize current algorithm";
	}
...
struct InitializeAllAlgorithmsAction : history::ModuleAction {
	...
	InitializeAllAlgorithmsAction() {
		name = "Delexandra Algomorph initialize all algorithms";
	}
