...
AlgomorphLargeWidget::DisallowMultipleModesAction::DisallowMultipleModesAction() {
    name = "Delexandra Algomorph disallow multiple modes";
}
...
AlgomorphLargeWidget::ResetKnobsAction::ResetKnobsAction() {
    name = "Delexandra Algomorph reset knobs";
}
...
AlgomorphLargeWidget::TogglePhaseOutRangeAction::TogglePhaseOutRangeAction() {
    name = "Delexandra Algomorph toggle phase output range";
}
...
AlgomorphLargeWidget::AlgomorphLargeWidget(AlgomorphLarge* module) {
    ...
    if (module) {
        ...
        ink = createSvgLight<AlgomorphLargeGlowingInk>(Vec(0,0), module, AlgomorphLarge::GLOWING_INK);
        ...
        addChild(createSvgSwitchLightCentered<DLXScreenButtonLight>(mm2px(Vec(35.428, 49.297)), module, AlgomorphLarge::SCREEN_BUTTON_LIGHT, AlgomorphLarge::SCREEN_BUTTON));

        addChild(createRingLightCentered<DLXMultiLight>(SceneButtonCenters[0], 8.862, module, AlgomorphLarge::SCENE_LIGHTS + 0, .75));
        addChild(createRingIndicatorCentered<Algomorph>(SceneButtonCenters[0], 8.862, module, AlgomorphLarge::SCENE_INDICATORS + 0, .75));
        addParam(createParamCentered<DLXTL1105B>(SceneButtonCenters[0], module, AlgomorphLarge::SCENE_BUTTONS + 0));
        addChild(createSvgSwitchLightCentered<DLX1Light>(SceneButtonCenters[0], module, AlgomorphLarge::ONE_LIGHT, AlgomorphLarge::SCENE_BUTTONS + 0));

        addChild(createRingLightCentered<DLXMultiLight>(SceneButtonCenters[1], 8.862, module, AlgomorphLarge::SCENE_LIGHTS + 3, .75));
        addChild(createRingIndicatorCentered<Algomorph>(SceneButtonCenters[1], 8.862, module, AlgomorphLarge::SCENE_INDICATORS + 3, .75));
        addParam(createParamCentered<DLXTL1105B>(SceneButtonCenters[1], module, AlgomorphLarge::SCENE_BUTTONS + 1));
        addChild(createSvgSwitchLightCentered<DLX2Light>(SceneButtonCenters[1], module, AlgomorphLarge::TWO_LIGHT, AlgomorphLarge::SCENE_BUTTONS + 1));

        addChild(createRingLightCentered<DLXMultiLight>(SceneButtonCenters[2], 8.862, module, AlgomorphLarge::SCENE_LIGHTS + 6, .75));
        addChild(createRingIndicatorCentered<Algomorph>(SceneButtonCenters[2], 8.862, module, AlgomorphLarge::SCENE_INDICATORS + 6, .75));
        addParam(createParamCentered<DLXTL1105B>(SceneButtonCenters[2], module, AlgomorphLarge::SCENE_BUTTONS + 2));
        addChild(createSvgSwitchLightCentered<DLX3Light>(SceneButtonCenters[2], module, AlgomorphLarge::THREE_LIGHT, AlgomorphLarge::SCENE_BUTTONS + 2));

        addInput(createInput<DLXPortPoly>(mm2px(Vec(3.778, 17.065)), module, AlgomorphLarge::AUX_INPUTS + 0));
        addInput(createInput<DLXPortPoly>(mm2px(Vec(3.778, 29.168)), module, AlgomorphLarge::AUX_INPUTS + 1));
        addInput(createInput<DLXPortPoly>(mm2px(Vec(3.778, 41.646)), module, AlgomorphLarge::AUX_INPUTS + 2));
        addInput(createInput<DLXPortPoly>(mm2px(Vec(3.778, 54.123)), module, AlgomorphLarge::AUX_INPUTS + 3));
        addInput(createInput<DLXPortPoly>(mm2px(Vec(3.778, 66.600)), module, AlgomorphLarge::AUX_INPUTS + 4));

        DLXLargeKnobLight* morphKnobLight = createLight<DLXLargeKnobLight>(mm2px(Vec(25.385, 97.379)), module, AlgomorphLarge::MORPH_KNOB_LIGHT);
        addParam(createLightKnob<DLXLargeKnobLight, DLXLargeLightKnob>(mm2px(Vec(25.385, 97.379)), module, AlgomorphLarge::MORPH_KNOB, morphKnobLight));
        ...
        addOutput(createOutput<DLXPortPolyOut>(mm2px(Vec(60.341, 46.446)), module, AlgomorphLarge::PHASE_OUTPUT));
        addOutput(createOutput<DLXPortPolyOut>(mm2px(Vec(60.341, 56.467)), module, AlgomorphLarge::MODULATOR_SUM_OUTPUT));
        addOutput(createOutput<DLXPortPolyOut>(mm2px(Vec(60.341, 66.600)), module, AlgomorphLarge::CARRIER_SUM_OUTPUT));

        addChild(createRingLightCentered<DLXYellowLight>(mm2px(Vec(35.428, 91.561)), 8.862, module, AlgomorphLarge::EDIT_LIGHT, .4));
        addChild(createParamCentered<DLXPurpleButton>(mm2px(Vec(35.428, 91.561)), module, AlgomorphLarge::EDIT_BUTTON));
        addChild(createSvgSwitchLightCentered<DLXPencilLight>(mm2px(Vec(35.428 + 0.07, 91.561 - 0.297)), module, AlgomorphLarge::EDIT_LIGHT, AlgomorphLarge::EDIT_BUTTON));

        addInput(createInput<DLXPortPoly>(mm2px(Vec(3.777, 78.636)), module, AlgomorphLarge::OPERATOR_INPUTS + 3));
        addInput(createInput<DLXPortPoly>(mm2px(Vec(3.777, 88.657)), module, AlgomorphLarge::OPERATOR_INPUTS + 2));
        addInput(createInput<DLXPortPoly>(mm2px(Vec(3.777, 98.678)), module, AlgomorphLarge::OPERATOR_INPUTS + 1));
        addInput(createInput<DLXPortPoly>(mm2px(Vec(3.777, 108.699)), module, AlgomorphLarge::OPERATOR_INPUTS + 0));

        addOutput(createOutput<DLXPortPolyOut>(mm2px(Vec(60.341, 78.636)), module, AlgomorphLarge::MODULATOR_OUTPUTS + 3));
        addOutput(createOutput<DLXPortPolyOut>(mm2px(Vec(60.341, 88.657)), module, AlgomorphLarge::MODULATOR_OUTPUTS + 2));
        ...
        addChild(createRingLightCentered<DLXMultiLight>(OpButtonCenters[3], 8.862, module, AlgomorphLarge::OPERATOR_LIGHTS + 9));
        addChild(createRingLightCentered<DLXMultiLight>(OpButtonCenters[2], 8.862, module, AlgomorphLarge::OPERATOR_LIGHTS + 6));
        addChild(createRingLightCentered<DLXMultiLight>(OpButtonCenters[1], 8.862, module, AlgomorphLarge::OPERATOR_LIGHTS + 3));
        addChild(createRingLightCentered<DLXMultiLight>(OpButtonCenters[0], 8.862, module, AlgomorphLarge::OPERATOR_LIGHTS + 0));
    
        addChild(createRingIndicatorCentered<Algomorph>(OpButtonCenters[3], 8.862, module, AlgomorphLarge::CARRIER_INDICATORS + 9, 0.8f));
        addChild(createRingIndicatorCentered<Algomorph>(OpButtonCenters[2], 8.862, module, AlgomorphLarge::CARRIER_INDICATORS + 6, 0.8f));
        addChild(createRingIndicatorCentered<Algomorph>(OpButtonCenters[1], 8.862, module, AlgomorphLarge::CARRIER_INDICATORS + 3, 0.8f));
        addChild(createRingIndicatorCentered<Algomorph>(OpButtonCenters[0], 8.862, module, AlgomorphLarge::CARRIER_INDICATORS + 0, 0.8f));

        addChild(createRingLightCentered<DLXMultiLight>(ModButtonCenters[3], 8.862, module, AlgomorphLarge::MODULATOR_LIGHTS + 9));
        addChild(createRingLightCentered<DLXMultiLight>(ModButtonCenters[2], 8.862, module, AlgomorphLarge::MODULATOR_LIGHTS + 6));
        addChild(createRingLightCentered<DLXMultiLight>(ModButtonCenters[1], 8.862, module, AlgomorphLarge::MODULATOR_LIGHTS + 3));
        addChild(createRingLightCentered<DLXMultiLight>(ModButtonCenters[0], 8.862, module, AlgomorphLarge::MODULATOR_LIGHTS + 0));
...
void AlgomorphLargeWidget::appendContextMenu(Menu* menu) {
    ...
    menu->addChild(construct<AuxInputModeMenuItem>(&MenuItem::text, "Aqua…", &MenuItem::rightText, (module->auxInput[0]->activeModes > 1 ? "Multiple" : AuxInputModeLabels[module->auxInput[0]->lastSetMode]) + " " + RIGHT_ARROW, &AuxInputModeMenuItem::module, module, &AuxInputModeMenuItem::auxIndex, 0));
    menu->addChild(construct<AuxInputModeMenuItem>(&MenuItem::text, "Fira…", &MenuItem::rightText, (module->auxInput[1]->activeModes > 1 ? "Multiple" : AuxInputModeLabels[module->auxInput[1]->lastSetMode]) + " " + RIGHT_ARROW, &AuxInputModeMenuItem::module, module, &AuxInputModeMenuItem::auxIndex, 1));
    menu->addChild(construct<AuxInputModeMenuItem>(&MenuItem::text, "Sol…",  &MenuItem::rightText, (module->auxInput[2]->activeModes > 1 ? "Multiple" : AuxInputModeLabels[module->auxInput[2]->lastSetMode]) + " " + RIGHT_ARROW, &AuxInputModeMenuItem::module, module, &AuxInputModeMenuItem::auxIndex, 2));
    menu->addChild(construct<AuxInputModeMenuItem>(&MenuItem::text, "Cura…", &MenuItem::rightText, (module->auxInput[3]->activeModes > 1 ? "Multiple" : AuxInputModeLabels[module->auxInput[3]->lastSetMode]) + " " + RIGHT_ARROW, &AuxInputModeMenuItem::module, module, &AuxInputModeMenuItem::auxIndex, 3));
    menu->addChild(construct<AuxInputModeMenuItem>(&MenuItem::text, "Vida…", &MenuItem::rightText, (module->auxInput[4]->activeModes > 1 ? "Multiple" : AuxInputModeLabels[module->auxInput[4]->lastSetMode]) + " " + RIGHT_ARROW, &AuxInputModeMenuItem::module, module, &AuxInputModeMenuItem::auxIndex, 4));
