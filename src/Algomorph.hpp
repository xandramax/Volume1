...
struct Algomorph : Module {
    ...
    rack::dsp::RingBuffer<float, 2> displayMorph;
    ...
    rack::dsp::RingBuffer<int, 2> displayScene;
    rack::dsp::RingBuffer<int, 2> displayMorphScene;
    ...
    rack::dsp::RingBuffer<std::bitset<16>, 2> displayAlgoName[3];       // When operators are disabled, remove their mod destinations from here
