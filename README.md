...
# Instructions:
* To install a [pre-compiled build](https://github.com/anlexmatos/FM-Delexandra/releases/tag/Beta-3), follow [these directions](https://vcvrack.com/manual/Installing#installing-plugins-not-available-on-the-vcv-library).
